# -*- coding: utf-8 -*-
#
# This file is part of the PIE754 project
#
#
#
...
# Additional import
# PROTECTED REGION ID(PIE754.additionnal_import) ENABLED START #
from pipython import GCSDevice, pitools
# PROTECTED REGION END #    //  PIE754.additionnal_import
    ...
    **Properties:**
    ...
    - Device Property
        ...
        axis_name
            - Type:'DevString'
    """
    # PROTECTED REGION ID(PIE754.class_variable) ENABLED START #
    ...
    # PROTECTED REGION END #    //  PIE754.class_variable
    ...
    def init_device(self):
        """Initialises the attributes and properties of the PIE754."""
        Device.init_device(self)
        # PROTECTED REGION ID(PIE754.init_device) ENABLED START #
        ...
        try:
            ...
            self.set_state(DevState.FAULT)
            print(e)
        # PROTECTED REGION END #    //  PIE754.init_device

    def always_executed_hook(self):
        """Method always executed before any TANGO command is executed."""
        # PROTECTED REGION ID(PIE754.always_executed_hook) ENABLED START #
        pass
        # PROTECTED REGION END #    //  PIE754.always_executed_hook
    ...
    def delete_device(self):
        ...
        """
        # PROTECTED REGION ID(PIE754.delete_device) ENABLED START #
        self.pi_ctrl.close()
        print('Controller disconnected.')
        # PROTECTED REGION END #    //  PIE754.delete_device
    # ------------------
    # Attributes methods
    # ------------------

    def read_Position(self):
        # PROTECTED REGION ID(PIE754.Position_read) ENABLED START #
        return self.__position
        # PROTECTED REGION END #    //  PIE754.Position_read

    def write_Position(self, value):
        # PROTECTED REGION ID(PIE754.Position_write) ENABLED START #
        self.write_DialPosition(self.sign * value - self.offset)
        # PROTECTED REGION END #    //  PIE754.Position_write

    def read_Velocity(self):
        # PROTECTED REGION ID(PIE754.Velocity_read) ENABLED START #
        ...
        # PROTECTED REGION END #    //  PIE754.Velocity_read

    def write_Velocity(self, value):
        # PROTECTED REGION ID(PIE754.Velocity_write) ENABLED START #
        """Set the Velocity attribute."""
        try:
            self.pi_ctrl.VEL('1', value)
        except BaseException as e:
            print('Problem setting the velocity, the error is: ', e)
        # PROTECTED REGION END #    //  PIE754.Velocity_write

    def read_DialPosition(self):
        # PROTECTED REGION ID(PIE754.DialPosition_read) ENABLED START #
        """Return the DialPosition attribute."""
        return self.__dial_position
        # PROTECTED REGION END #    //  PIE754.DialPosition_read

    def write_DialPosition(self, value):
        # PROTECTED REGION ID(PIE754.DialPosition_write) ENABLED START #
        ...
        # PROTECTED REGION END #    //  PIE754.DialPosition_write

    def read_OnTarget(self):
        # PROTECTED REGION ID(PIE754.OnTarget_read) ENABLED START #
        ...
        try:
            ...
            self.set_state(DevState.FAULT)
        # PROTECTED REGION END #    //  PIE754.OnTarget_read

    def read_ServoOn(self):
        # PROTECTED REGION ID(PIE754.ServoOn_read) ENABLED START #
        ...
        # PROTECTED REGION END #    //  PIE754.ServoOn_read

    def write_ServoOn(self, value):
        # PROTECTED REGION ID(PIE754.ServoOn_write) ENABLED START #
        ...
        # PROTECTED REGION END #    //  PIE754.ServoOn_write

    def read_PosError(self):
        # PROTECTED REGION ID(PIE754.PosError_read) ENABLED START #
        """Return the PosError attribute."""
        return self.__pos_error
        # PROTECTED REGION END #    //  PIE754.PosError_read

    def read_PosTolerance(self):
        # PROTECTED REGION ID(PIE754.PosTolerance_read) ENABLED START #
        """Return the PosTolerance attribute."""
        return self.__pos_tolerance
        # PROTECTED REGION END #    //  PIE754.PosTolerance_read

    def write_PosTolerance(self, value):
        # PROTECTED REGION ID(PIE754.PosTolerance_write) ENABLED START #
        """Set the PosTolerance attribute."""
        self.__pos_tolerance = value
        # PROTECTED REGION END #    //  PIE754.PosTolerance_write
    ...
    @DebugIt()
    def GetError(self):
        # PROTECTED REGION ID(PIE754.GetError) ENABLED START #
        return ""
        # PROTECTED REGION END #    //  PIE754.GetError

    @command(
    )
    @DebugIt()
    def AcknError(self):
        # PROTECTED REGION ID(PIE754.AcknError) ENABLED START #
        """
        ...
        # PROTECTED REGION END #    //  PIE754.AcknError
...
def main(args=None, **kwargs):
    """Main function of the PIE754 module."""
    # PROTECTED REGION ID(PIE754.main) ENABLED START #
    return run((PIE754,), args=args, **kwargs)
    # PROTECTED REGION END #    //  PIE754.main
